...
namespace SimulacionDeRestauranta.Services
{
...

    {
        ...
        public ResultadoSimulacion EjecutarSimulacion(int cantidadPedidos, List<string> menu)
        {
            ...
            var pedidosOriginales = GenerarPedidos(cantidadPedidos, menu.ToArray());
            ...
            resultado.TiempoSecuencial = Math.Round(swSecuencial.Elapsed.TotalSeconds, 2);
            //Entregas a tiempo
            ...
            foreach (int procesadores in nivelesParalelismo)
            {
                ...
                double tiempoParalelo = Math.Round(swParalelo.Elapsed.TotalSeconds, 2);
                double speedup = Math.Round(resultado.TiempoSecuencial / tiempoParalelo, 2);
                double eficiencia = Math.Round((speedup / procesadores) * 100.0, 2);
        ...
        private List<Pedido> GenerarPedidos(int cantidad, string[] menu)
        {
...

        {
            ...
            switch (pedido.Platillo)
            {
                case "Yaroa":
                    Console.WriteLine("Preparando Yaroa...");
                    Thread.Sleep(50);
                    Console.WriteLine("Yaroa Lista.");
                    break;
                ...
                case "Hamburguesa":
                    ...
                    Thread.Sleep(70);
                    Console.WriteLine("Hamburguesa Lista.");
                    break;

                case "Tacos":
                    Console.WriteLine("Preparando Tacos...");
                    Thread.Sleep(80);
                    Console.WriteLine("Tacos Lista.");
                    break;

                case "Burrito":
                    Console.WriteLine("Preparando Burrito...");
                    Thread.Sleep(40);
                    Console.WriteLine("Burrito Lista.");
                    break;
            }
